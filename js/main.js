...
var editDisplay = {
    lock: function(){
        ...
        $("#entry_tags").tokenInput("toggleDisabled", true);
    ...
    unlock: function(){
        ...
        if(validTags.length > 0){
            // Do this in case we get here before getValidTags() is finished
            // tokenInput is initialised there
            $("#entry_tags").tokenInput("toggleDisabled", false);
        }
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $(editData['tags']).each(function(index, tagObj){
                    $("#entry_tags").tokenInput("add", tagObj);
                });
...
function getValidTags(){
    $.ajax({
        ...
        success:function(data){
            ...
            $('#entry_tags').tokenInput(validTags, {
            ...
            // This is generated by facebook theme of tokenInput
            $('.token-input-list-facebook').addClass('form-control').css({width: 314});
        },
        error:function(){
            // Do nothing. User doesn't need to know about this.
        }
